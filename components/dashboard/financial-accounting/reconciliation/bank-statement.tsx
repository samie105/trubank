...
export default function BankReconciliationTable() {
  ...
  return (
    <div className="w-full">
      ...
      <div className=" p-4 rounded-lg border mb-6">
        <div className="grid grid-cols-2 gap-8">
          <div>
            ...
            <div className="bg-green-500/10 text-green-500 px-2 py-1 rounded-md text-sm inline-block">
              Reconciled
            </div>
          </div>
          <div>
          ...
          <div>
            <div className="text-sm font-medium mb-1"> Impacted Report:</div>
      ...
      <div className="mb-6">
        <h3 className="font-medium mb-2">Bank Statemnt </h3>
