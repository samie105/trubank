    ...
    >
      {value.map((item, index) => (
        <Badge
          key={item}
          className={cn(
            "p-1 rounded-md flex items-center gap-1",
        ...
        >
          ...
          >
            ...
            <RemoveIcon className="h-4 w-4 hover:stroke-muted-foreground" />
          </button>
        </Badge>
      ))}
      {children}
...
>(({ className, ...props }) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent outline-none my-1 w-auto placeholder:text-muted-foreground flex-1",
        className,
