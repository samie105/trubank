...
function CustomerEditor({ params }: { params: { id: string } }) {
    ...
    async function fetchCustomerData() {
      try {
        ...
        const response = await fetch(
          `${apiUrl}/customermanagement/get-individual-user?UserId=${params.id}`,
          {
            method: "GET",
            headers: {
        ...
        loadEditData(params.id, data.result)
    ...
    <div className="container mx-auto py-6">
      ...
      >
        ...
        <TabsContent value="confirm">
          <ConfirmDetails params={{ id: params.id, edit: true }} />
        </TabsContent>
      </Tabs>
    </div>
  )
...
// Main Page Component with FormProvider
export default function EditIndividualCustomerPage({ params }: { params: { id: string } }) {
  return (
    <FormProvider>
      <CustomerEditor params={params} />
    </FormProvider>
  )
} 